...
DROP TABLE `t_asm_asesmen_jawaban`;
CREATE TABLE `t_asm_asesmen_jawaban` (
  `jwb_idents` int NOT NULL AUTO_INCREMENT,
  `jwb_asoidents` int DEFAULT NULL,
  `jwb_tnyidents` int DEFAULT NULL,
  `jwb_jawab` tinyint DEFAULT NULL,
  `jwb_deskripsi` varchar(400) DEFAULT NULL,
  `jwb_link` varchar(200) DEFAULT NULL,
  `jwb_file` varchar(150) DEFAULT NULL,
  `jwb_status` tinyint DEFAULT '0',
  `jwb_status_kirim` TINYINT DEFAULT '0', 
  `jwb_is_deleted` tinyint DEFAULT NULL,
  `jwb_usrnam` varchar(100) DEFAULT NULL,
  `jwb_usrdat` datetime DEFAULT CURRENT_TIMESTAMP,
  `jwb_appnam` varchar(100) DEFAULT NULL,
  `jwb_appdat` datetime DEFAULT NULL,
  PRIMARY KEY (`jwb_idents`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DROP TABLE IF EXISTS t_inbox;
CREATE TABLE `t_inbox` (
  `inb_idents` int NOT NULL AUTO_INCREMENT,
  `inb_title` varchar(100) NOT NULL,
  `inb_message` varchar(2000) NULL,
  `inb_usrlogins` varchar(100) NULL,
  `inb_fkidents` INT NULL,
  `inb_delivery_status` varchar(100) NULL,
  `inb_delivery_plan_date` DATETIME NULL,
  `inb_is_read` smallint NULL,
  `inb_date_read` DATETIME NULL,
  `inb_date_reply` DATETIME NULL,
  `inb_usrnam` varchar(100) NULL,
  `inb_usrdat` DATETIME DEFAULT CURRENT_TIMESTAMP,
  `inb_readdat` DATETIME NULL,
  PRIMARY KEY (`inb_idents`)
) ENGINE=InnoDB AUTO_INCREMENT=1;


DROP TABLE IF EXISTS `t_asm_asesmen_history_approval`;
CREATE TABLE `t_asm_asesmen_history_approval` (
  `his_idents` int NOT NULL AUTO_INCREMENT,
  `his_jwbidents` int DEFAULT NULL,
  `his_ibxidents` int DEFAULT NULL,
  `his_jwbstatus` tinyint DEFAULT NULL,
  `his_alasan` varchar(400) DEFAULT NULL,
  `his_status` tinyint DEFAULT '0',
  `his_usrnam` varchar(100) DEFAULT NULL,
  `his_usrdat` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`his_idents`)
) ENGINE=InnoDB AUTO_INCREMENT=1;