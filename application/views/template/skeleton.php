...
<html lang="en">
	<head>
        ...
        <link href="<?=base_url(PLUGINS."metronic/css/global/plugins.bundle.css");?>" rel="stylesheet" type="text/css"/>
        <link href="<?=base_url(PLUGINS."metronic/css/style.bundle.css");?>" rel="stylesheet" type="text/css"/>
