...
<html lang="en">
	<head>
        ...
        <link href="<?=base_url(PLUGINS."metronic/css/css/themes/layout/header/base/dark.css?v=7.0.7");?>" rel="stylesheet" type="text/css"/>
        <link href="<?=base_url(PLUGINS."metronic/css/css/themes/layout/header/menu/dark.css?v=7.0.7");?>" rel="stylesheet" type="text/css"/>
	...
	<body id="kt_body" class="page-loading-enabled page-loading header-fixed header-mobile-fixed subheader-enabled subheader-fixed subheader-mobile-fixed aside-enabled aside-fixed aside-minimize aside-minimize-hoverable footer-fixed page-loading">
							<!-- <ul class="menu-nav">
	...
	?>
		...
		<!-- <div class="page-loader page-loader-logo">
            <img src="<?=base_url(IMAGES.$logo);?>" class="max-h-75px" alt="Logo"/>
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="/home/welcome">
                <!-- <img src="<?=base_url(IMAGES.$logo);?>" alt="Logo"/> -->
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
			...
			<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="brand flex-column-auto" id="kt_brand">
						<!--begin::Logo-->
						<a href="/home/welcome" class="brand-logo">
                            <img src="<?=base_url(IMAGES.$logo_light);?>" alt="Logo" style="height:20px"/>
						</a>
						<!--end::Logo-->
						<!--begin::Toggle-->
					...
					<div id="kt_header" class="header header-fixed">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
								<!--begin::Header Menu-->
								<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-tab">
								</div>
								<!--end::Header Menu-->
							</div>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<!--end::Info-->
								<!--begin::Toolbar-->
								<div class="d-flex align-items-center" id=buttonplace></div>
								<!--end::Toolbar-->
							</div>
						</div>
						<!--end::Subheader-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container-fluid">
								<div class="row" style="height:100%;width:100%">
									<div class="card card-custom" style="height:100%;width:100%">
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer" style="height:50px">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								<?=$usr_fnames . ($usr_levels!=1 ? " [ " . $desc . " ]" : " [ Administrator ]") ?>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<div class="nav nav-dark">
								<span id="sesiabis" style="padding-right: 10px;color:#20c997">Session anda berakhir dalam</span><span class="username" style="color:#ffba00;padding-right: 10px" id="clock"></span>
								<?=$show_envrm==true ? "[ " . ENVIRONMENT ." ]" : ""?>
								2019&nbsp;&copy;&nbsp;<a target="_blank" href="<?=base_url()?>" class="kt-link"><?=$this->config->item('app_names')?></a>&nbsp;&nbsp;&nbsp;
								Version <?=$svnversion?>
							</div>
							<!--end::Nav-->
						</div>
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<a href="/master/user/viewdetail" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								...
								<div class="text-muted">Informasi Pengguna</div>
							</div>
						</div>
					</a>
					<!--end:Item-->
					...
					<a href="/metronic/demo1/custom/apps/user/profile-3.html" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">Kata Sandi</div>
								<div class="text-muted">Ubah Kata Sandi</div>
							</div>
						</div>
					</a>
					<!--end:Item-->
					...
					<a href="/master/log/aktivitas" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								...
								<div class="text-muted">Log Akses dan Aktivitas Pengguna</div>
							</div>
						</div>
					</a>
					<!--end:Item-->
				...
				<div>
					<!--begin:Heading-->
					<h5 class="mb-5">Aktivitas Terakhir</h5>
					<!--end:Heading-->
					<!--begin::Item-->
					...
					<div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
						...
						<div class="mb-5">
							...
							<div class="d-flex align-items-center bg-light-warning rounded p-5 mb-5">
								...
								<div class="d-flex flex-column flex-grow-1 mr-2">
									<a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">xAnother purpose persuade</a>
									<span class="text-muted font-size-sm">Due in 2 Days</span>
								</div>
								<span class="font-weight-bolder text-warning py-1 font-size-lg">+28%</span>
							</div>
		...
		<!-- <script src="/metronic/theme/html/demo1/dist/assets/js/pages/widgets.js?v=7.0.7"></script> -->
		<!--end::Page Scripts-->
		<script>
													
			$(document).ready(function(){
				$('#buttonplace').html('<select class="form-control selectpicker"><option>Mustard</option><option>Ketchup</option><option><b>Relish</b></option></select>&nbsp;<a href="#" class="btn btn-light-primary font-weight-bolder btn-sm">Button</a>&nbsp;<a href="#" class="btn btn-light-primary font-weight-bolder btn-sm">Actions</a>')
			});
