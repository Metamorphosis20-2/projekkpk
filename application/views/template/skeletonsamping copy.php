...
<html lang="en">
	...
	<body id="kt_body" class="page-loading-enabled page-loading header-fixed header-mobile-fixed subheader-enabled subheader-fixed subheader-mobile-fixed aside-enabled aside-fixed <?=$aside_minimize?> aside-minimize-hoverable footer-fixed page-loading">
		<!--begin::Page loader-->
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row flex-column-fluid page">
				<!--begin::Aside-->
				<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside"  style='z-index:9999!important'>
					<!--begin::Brand-->
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="2229500">
							<!--begin::Menu Nav-->
							<?=$this->common->vmenu();?>
						</div>
						<!--end::Menu Container-->
						...
						<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center">
									...
									<div class="d-flex align-items-center" id=button_place></div>
								</div>
								<!--end::Toolbar-->
							</div>
						</div>
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer" style="height:50px">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="nav nav-dark">
								<span id="sesiabis" style="padding-right: 10px;color:#20c997"><?=$this->lang->line("sessi_berakhir")?></span><span class="username" style="color:#ffba00;padding-right: 10px" id="clock"></span>
								<?=$show_envrm==true ? "[ " . ENVIRONMENT ." ]" : ""?>
								2021&nbsp;&copy;&nbsp;<a target="_blank" href="<?=base_url()?>" class="kt-link"><?=$this->config->item('app_names')?></a>&nbsp;&nbsp;&nbsp;
								Version 1
							</div>
							<!--end::Nav-->
						</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary font-weight-bold" onclick="jvLogin()"><i class="fas fa-key"></i>Sign In</button>
					</div>
				</div>
			</div>
		</div>
		...
		<script>
			$(document).ready(function(){
				...
				var timeout = setInterval(reloadChat, 60000);    
